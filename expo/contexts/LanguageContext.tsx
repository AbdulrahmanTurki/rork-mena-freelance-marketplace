...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    more: "More",
    sar: "SAR",
    exploreServicesAcrossCategories: "Explore services across different categories",
    guestUser: "Guest User",
    signInToAccessProfile: "Sign in to access your profile",
    signInSignUp: "Sign In / Sign Up",
    sellerDashboardLabel: "Seller Dashboard",
    manageYourServicesDesc: "Manage your services",
  ...
  ar: {
    ...
    more: "المزيد",
    sar: "ريال",
    exploreServicesAcrossCategories: "استكشف الخدمات عبر فئات مختلفة",
    guestUser: "مستخدم ضيف",
    signInToAccessProfile: "سجل الدخول للوصول إلى ملفك الشخصي",
    signInSignUp: "تسجيل الدخول / التسجيل",
    sellerDashboardLabel: "لوحة البائع",
    manageYourServicesDesc: "إدارة خدماتك",
